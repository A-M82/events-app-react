...
function EventCard({ event, index }) {
  ...
  return (
    <Link
      to={`/events/${event.id}`}
      className="card group flex gap-5 p-5 hover:shadow-card-hover hover:border-brand-100
    ...
    >
      ...
      {date && (
        <div className="flex-shrink-0 w-14 flex flex-col items-center justify-center
                        bg-brand-50 rounded-xl py-2 px-1 border border-brand-100">
      ...
      <div className="flex-1 min-w-0">
        <h2 className="text-base font-display font-semibold text-slate-900 mb-1 truncate
      ...
      {/* Arrow */}
      <div className="flex-shrink-0 self-center text-slate-300 group-hover:text-brand-400
